...
<div class="container mt-3" style="border:1px solid #cecece;">
        ...
        <div id="fadeError">
       	...
       	<% } %>
<form name="signupForm" onsubmit="event.preventDefault(); validateForm(this)" method="post" action="<%=response.encodeURL("SignupServlet")%>">
  
  <div class="form-group">
    <label for="InputNome">Nome</label>
    <input type="text" class="form-control" name="nome" id="InputNome" placeholder="Mario">
    	<p id="errName" class="errTextInterior"></p>
  </div>
  
  <div class="form-group">
    <label for="InputCognome">Cognome</label>
    <input type="text" class="form-control" name="cognome" id="InputCognome" placeholder="Rossi">
    	<p id="errSurname" class="errTextInterior"></p>
  </div>
  
  <div class="form-group">
    <label class="active" for="data">Data di nascita</label>
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="InputEmail" name="email" aria-describedby="emailHelp" placeholder="m.rossi@gmail.com">
    	<p id="errEmail" class="errTextInterior"></p>
  </div>
...
<script>
		...
		function validateEmail(emailTxt){
			...
			return emailTxt.match(emailRegex);
		}
		...
		function validateForm(obj) {
			...
			var emailErr =  document.getElementsByName("email")[0];
			if ( !( validateEmail(email) ) ) {
				emailErr.classList.add("error");
				document.getElementById('errEmail').innerHTML="Email non valida (Caratteri alfanumerici e simboli come ., - seguiti da @, dominio e . seguito da suffisso)";
				valid = false;
			} else {
